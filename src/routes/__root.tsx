...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bioprag | Controle Integrado de Pragas e Biossegurança" },
      { property: "og:title", content: "Bioprag | Controle Integrado de Pragas e Biossegurança" },
      { name: "twitter:title", content: "Bioprag | Controle Integrado de Pragas e Biossegurança" },
